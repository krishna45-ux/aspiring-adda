...
import { Compass, Sparkles, MessageSquare, Map } from 'lucide-react';
  ...
  return (
    <div className="pt-24 md:pt-32 pb-16 md:pb-24 px-4 md:px-6 text-center relative overflow-hidden min-h-[90vh] flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 max-w-5xl w-full">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 w-full px-4 sm:px-0 flex-wrap">
          ...
          <Button onClick={() => navigate('guidance')} size="lg" variant="secondary" icon={Map} className="w-full sm:w-auto dark:bg-nebula-teal/20 dark:border-nebula-teal/40 dark:text-nebula-teal dark:hover:bg-nebula-teal/30">
            Career Guidance
          </Button>
        </div>
